...
<template>
  ...
  <Transition name="rewards-hub">
    <div
      v-show="show"
      class="z-[10] fixed flex flex-col top-[80px] left-[12px] right-[12px] md:left-auto md:right-[20px] bottom-[42px] md:bottom-auto md:w-[430px] md:h-[75%] max-h-[824px] rounded-[2px] bg-[#1c1c1c]"
    >
